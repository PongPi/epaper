 ...
 */
class List_Table_Dowload extends WP_List_Table {
    ...
    function get_data_user_detail_backend(){
        ...
        $results = $wpdb->get_results("SELECT `id`,`id_user`,`id_product`,`name_product`,COUNT(id_product) as SL FROM $table_name GROUP BY `id_product`", ARRAY_A);
        return $results;
    }
    ...
    function get_columns(){
        $columns = array(
            ...
            'id_product'    => 'ID tài liệu',
            'name_product'    => 'Tên tài liệu',
            'SL'  => 'Lượt tải'
        );
        return $columns;
    }
    ...
    function get_sortable_columns() {
        $sortable_columns = array(
            ...
            'name_product'    => array('name_product',false),
            'SL'  => array('SL',true)
        );
 ...
 */
function render_list_table_dowload(){
    
    //Create an instance of our package class...
    $listTableDownload = new List_Table_Dowload();
    //Fetch, prepare, sort, and filter our data...
    $listTableDownload->prepare_items();
    
    ?>
    <div class="wrap">
        
        <div id="icon-users" class="icon32"><br/></div>
        <h2>Danh sách download</h2>
        
        <form id="movies-filter" method="get">
            <!-- For plugins, we also need to ensure that the form posts back to our current page -->
            <input type="hidden" name="page" value="<?php echo $_REQUEST['page'] ?>" />
            <!-- Now we can render the completed list table -->
            <?php $listTableDownload->display() ?>
        </form>
