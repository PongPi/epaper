    ...
    function widget($args, $instance) {
        ...
        <div class="contact-info">
            ...
            <ul class="contact-details">
                <?php if ($address) : ?><li><i class="fa fa-map-marker"></i> <strong><?php _e('Address', 'porto-widgets') ?>:</strong> <span><?php echo esc_html($address) ?></span></li><?php endif; ?>
                <?php if ($phone) : ?><li><i class="fa fa-phone"></i> <strong><?php _e('Phone', 'porto-widgets') ?>:</strong> <span><?php echo esc_html($phone) ?></span></li><?php endif; ?>
                ...
                <?php if ($working) : ?><li><i class="fa fa-clock-o"></i> <strong><?php _e('Working Days/Hours', 'porto-widgets') ?>:</strong> <span><?php echo esc_html($working) ?></span></li><?php endif; ?>
            </ul>
