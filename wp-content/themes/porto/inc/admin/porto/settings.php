                ...
                'fields' => array(
                    array(
                        ...
                        'desc' => '<br/>' . (isset($_GET['compile_theme_success'])?'<strong style="font-size: 15px; color: #000;">' . __('Theme CSS compiled successfully!', 'porto') . '</strong><br/><br/>':'')
                            ...
                            . __('After compile, will be regenerate the css files (theme_' . get_current_blog_id() . '.css, theme_rtl_' . get_current_blog_id() . '.css, plugins_' . get_current_blog_id() . '.css, plugins_rtl_' . get_current_blog_id() . '.css, skin_rtl_' . get_current_blog_id() . '.css) in ', 'porto') . '<strong>' . porto_dir . '/css</strong>.</span>',
                    ),
